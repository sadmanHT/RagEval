...
The small committed fixtures verify mechanics, provenance, deterministic ordering, retry/error handling, top-5 orchestration, and two-hop recovery rather than production retrieval quality. No neural-reranking quality, target-corpus retrieval improvement, or generation metric is claimed from these fixtures.
